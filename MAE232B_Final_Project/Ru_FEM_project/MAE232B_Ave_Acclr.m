...
%     end
    ...
    title('Radial Stress by Averaged Acceleration')
    ...
    title('Circumferential Stress by Averaged Acceleration')
    ...
    title('Displacements by Averaged Acceleration')
...
%     xlabel('radius (in)')
%     ylabel('radial stress \sigma_{rr} (psi)')
%     title('Radial stress distribution by Averaged Acceleration Method')
% 
%     subplot(3,1,2)
...
%     xlabel('radius (in)')
%     ylabel('circumferential stress \sigma_{\theta\theta} (psi)')
%     title('Circumferential Stress distribution by Averaged Acceleration Method')
% 
% 
%     subplot(3,1,3)
...
%     xlabel('radius (in)')
%     ylabel('Displacement d (in)')
%     title('Displacement distribution by Averaged Acceleration Method')
