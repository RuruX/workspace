...
with XDMFFile(MPI.COMM_WORLD,'mesh_tri_25_25.xdmf','r',encoding=encoding) as xdmf:
...
dolfinx.io.VTKFile("meshout_tri_25_25.pvd").write(mesh)
...
with XDMFFile(MPI.COMM_WORLD, "meshout_tri_25_25.xdmf", "w") as file:
