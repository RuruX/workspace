...
with XDMFFile(MPI.COMM_WORLD,'mesh_tri_5_10.xdmf','r',encoding=encoding) as xdmf:
...
dolfinx.io.VTKFile("meshout_tri_5_10.pvd").write(mesh)
...
with XDMFFile(MPI.COMM_WORLD, "meshout_tri_5_10.xdmf", "w") as file:
