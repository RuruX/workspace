...
with XDMFFile(MPI.COMM_WORLD,'mesh_tri.xdmf','r',encoding=encoding) as xdmf:
...
dolfinx.io.VTKFile("meshout_tri.pvd").write(mesh)
...
with XDMFFile(MPI.COMM_WORLD, "meshout_tri.xdmf", "w") as file:
