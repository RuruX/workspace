...
import ufl
from tIGAr import *
from set_IGA_shell import set_IGA
...
if __name__ == '__main__':
    ...
    iga_test = iga
    pde_res = iga_test.pdeRes(iga_test.u, iga_test.v, iga_test.t)
    iga_test.compute_derivative(iga_test.u, iga_test.v, iga_test.t)
    dRdf = assemble(derivative(pde_res, iga_test.t))
    dRdf_petsc = as_backend_type(dRdf).mat().convert("dense")
